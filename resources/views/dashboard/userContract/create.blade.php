      ...
      <div class="card-body">
        ...
        <div class="row" style="margin-bottom: 20px">
            ...
            <div class="col-md-4">
                ...
                <a href="{{route('dashboard.UserContract.store')}}" class="btn btn-primary"><i class="fa fa-plus" style="padding-left: 5px"></i>@lang('site.add')</a>
                @else
        ...
        <!-- form start -->
        <form action="{{route('dashboard.UserContract.store')}}" method="POST" >
          @csrf
          {{method_field('post')}}
          ...
          <div class="tab-pane fade active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="contFirstLast" class="form-control" value="">
              </div>
              

              <div class="form-group">
                <label for="exampleInput1">@lang('site.contLast')</label>
                <input type="text" name="contLast" class="form-control" id="exampleInput1" placeholder="">
              </div>    
